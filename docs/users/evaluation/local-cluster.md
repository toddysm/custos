...
> **M1 evaluation build.** No Web UI, operator-bootstrapped service tokens, and
> single-replica infrastructure. After verification, run the
> [first-admin ceremony](../../operations/bootstrap-admin.md).
